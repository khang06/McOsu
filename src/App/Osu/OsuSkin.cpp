...
ConVar osu_pitch_hitsounds_when_not_300("osu_pitch_hitsounds_when_not_300", true, FCVAR_NONE, "Lowers or raises the pitch of the hitsound when hitting before or after the correct timing.");
